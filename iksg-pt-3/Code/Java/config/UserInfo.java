...
public class UserInfo implements Serializable {
	...
	public boolean isStaff() {
		return FrameworkUtils.getDatabase().queryAccessRoles(getName()).contains("[Staff]");
	}
	public boolean isClient() {
		return FrameworkUtils.getDatabase().queryAccessRoles(getName()).contains("[Client]");
	}
	...
	public String getProfileImageUrl() {
		...
		return "https://secure.gravatar.com/avatar/" + MD5Util.md5Hex(email) + "&s=36";
	}
}
class MD5Util {
